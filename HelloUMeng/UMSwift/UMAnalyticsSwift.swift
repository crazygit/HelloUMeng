...
class UMAnalyticsSwift: NSObject {
    ...
    /** 自定义事件,数量统计.
     使用前，请先到友盟App管理后台的设置->编辑自定义事件 中添加相应的事件ID，然后在工程中传入相应的事件ID
     */
    static func event(eventId: String, attributes: [String: Any]) {
        MobClick.event(eventId, attributes: attributes)
    }

    static func event(eventId: String, attributes: [String: Any], counter: Int) {
    ...
    /** 自定义事件,时长统计.
     使用前，请先到友盟App管理后台的设置->编辑自定义事件 中添加相应的事件ID，然后在工程中传入相应的事件ID.
     */
    static func beginEvent(eventId: String, primarykey: String, attributes: [String: Any]) {
    ...
    /** 自定义事件,时长统计.
     使用前，请先到友盟App管理后台的设置->编辑自定义事件 中添加相应的事件ID，然后在工程中传入相应的事件ID.
     */
    static func event(eventId: String, attributes: [String: Any], millisecond: Int) {
     ...
     */
    static func registerPreProperties(property: [String: Any]) {
     ...
     */
//    static func getPreProperties() -> [String: Any] {
//        MobClick.getPreProperties() as! [String: Any]
//    }
     ...
     */
    static func setFirstLaunchEvent(eventList: [String]) {
